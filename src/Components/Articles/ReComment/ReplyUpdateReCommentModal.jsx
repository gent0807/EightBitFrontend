...
const ReplyUpdateReCommentModal = ({ 
    setModalReplyUpdateReCommentOnOff, 
    ModalReplyUpdateReCommentOnOff, 
}) => {

    return (
        <DeleteModalBackground OnOff={ModalReplyUpdateReCommentOnOff}>
            <ReportModalAllBox>
                    <ModalDeleteBtn
                        onClick={() => setModalReplyUpdateReCommentOnOff(!ModalReplyUpdateReCommentOnOff)}>
                        x
                    </ModalDeleteBtn>
...
export default ReplyUpdateReCommentModal;
