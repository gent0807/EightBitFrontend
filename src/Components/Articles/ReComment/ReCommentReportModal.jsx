...
const ReCommentReportModal = ({ setReportMode, ReportMode, regdate, reCommenter }) => {
            ...
            <ReportModalAllBox ModalChange={ismodalchange}>
                <SubmitBox onSubmit={Sumbit}>
                    ...
                    <ReportRadioBox>
                        <RadioBtnBox>
                            <RadioBtn
                                id={reCommenter + regdate}
                                type="radio"
                                value="욕설/비방 신고"
                                onChange={(e) => RadioAbusehandle(e)}
                                checked={RadioAbuseBtnOnOff}
                            />
                            <RadioBtnlabel check={RadioAbuseBtnOnOff} htmlFor={reCommenter + regdate}>욕설/비방 신고</RadioBtnlabel>
                        </RadioBtnBox>

                        <RadioBtnBox>
                            <RadioBtn
                                id={reCommenter + regdate + 1}
                                type="radio"
                                value="음란물 신고"
                                onChange={(e) => Radio19handle(e)}
                                checked={Radio19BtnOnOff}
                            />
                            <Radio19Btnlabel check={Radio19BtnOnOff} htmlFor={reCommenter + regdate + 1}>음란물 신고</Radio19Btnlabel>
                        </RadioBtnBox>

                        <RadioBtnBox>
                            <RadioBtn
                                id={reCommenter + regdate + 2}
                                type="radio"
                                value="게시판 부적합 신고"
                                onChange={(e) => RadioIncoporatehandle(e)}
                                checked={RadioIncoporateBtnOnOff}
                            />
                            <RadioBtnIncoporatehandlelabel check={RadioIncoporateBtnOnOff} htmlFor={reCommenter + regdate + 2}>게시판 부적합 신고</RadioBtnIncoporatehandlelabel>
                        </RadioBtnBox>
...
export default ReCommentReportModal;
